...
class ObjectivesDeleteSubtaskArguments(TaskArguments):
...
class ObjectivesDeleteSubtask(CommandBase):
    cmd = "objectives_delete_subtask"
    needs_admin = False
    help_cmd = "objectives_delete_subtask -id 4"
    description = "Delete an objective"
    version = 1
    author = "@its_a_feature_"
    argument_class = ObjectivesDeleteSubtaskArguments
    supported_ui_features = ["ghostwriter:objectives_delete_subtask"]
    ...
    async def create_go_tasking(self,
        ...
        objectives_delete_mutation = gql(
            ...
            mutation objectives_delete($id: bigint!) {
              delete_objectiveSubTask_by_pk(id: $id) {
                complete
                deadline
                markedComplete
                objectiveStatus {
